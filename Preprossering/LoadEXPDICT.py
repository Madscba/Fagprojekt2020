...
if __name__ == '__main__':
    y_true_bal, test_size_bal, RF_pred_bal, SVM_pred_bal, LDA_pred_bal, GNB_pred_bal, index_bal, filenames_bal=load_pred(r"ClassifierTestLogs", r"Spectrograms_bal_final1_predict.json", ['SVM', 'LDA', 'RF', 'GNB'])
    y_true_unbal, test_size_unbal, RF_pred_unbal, SVM_pred_unbal, LDA_pred_unbal, GNB_pred_unbal, index_unbal, filenames_unbal=load_pred(r"ClassifierTestLogs", r"Spectrograms_unbal_final1_predict.json", ['SVM', 'LDA', 'RF', 'GNB'])
    y_true_unbal_feat, test_size_unbal_feat, RF_pred_unbal_feat, SVM_pred_unbal_feat, LDA_pred_unbal_feat, GNB_pred_unbal_feat, index_unbal_feat, filenames_unbal_feat = load_pred(r"ClassifierTestLogs", r"Feature_unbal_final1_predict.json", ['SVM', 'LDA', 'RF', 'GNB'])
    y_true_bal_feat, test_size_bal_feat, RF_pred_bal_feat, SVM_pred_bal_feat, LDA_pred_bal_feat, GNB_pred_bal_feat, index_bal_feat, filenames_bal_feat = load_pred(r"ClassifierTestLogs", r"Feture_bal_final1_predict.json", ['SVM', 'LDA', 'RF', 'GNB'])
