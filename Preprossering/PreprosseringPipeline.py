...
class preprossingPipeline:
    ...
    def make_label(self,make_spectograms=True, quality=None, is_usable =None, max_files=10, path = '/Users/villadsstokbro/Dokumenter/DTU/KID/3. semester/Fagprojekt/spectograms_all_ch/',seed=0):
        i=0
