...
def train_CNN(model,batch_size,num_epochs,x_train,x_valid,y_train,y_valid):
    ...
    for epoch in range(num_epochs):
        ...
        for i in range(num_batches_train):
            ...
            target_batch = Variable(torch.from_numpy(y_train[slce]).long())
...
ta, va = train_CNN(model,batch_size,num_epochs,x_train,x_valid,y_train,y_valid)