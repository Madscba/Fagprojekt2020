...
feature_vectors_9_10,labels_9_10,filenames_1,idx_1= C.make_label(max_files=5,quality=[9,10],is_usable=None,path = path, max_windows=40)
...
sp3, l3, f3, i3 = C.make_label(max_files=5,quality=[9,10],is_usable=None,path = path2, max_windows=40)
sp3, l3, f3, i3 = C.make_label(max_files=5,quality=[9,10],is_usable=None,path = path2, max_windows=40)
...
plot_pca(pca_v,le2,np.unique(ln),model='PCA spectograms')
plot_pca(tsne_v,le2,np.unique(ln),model='TSNE spectograms')
plot_pca(lda_v,le2,np.unique(ln),model='LDA spectograms')
...
plot_pca(pca_vectors,le,np.unique(labels_new),model='PCA feature vectors')
plot_pca(tsne_vectors,le,np.unique(labels_new),model='TSNE feature vectors')
plot_pca(lda_vectors,le,np.unique(labels_new),model='LDA feature vectors')