...
feature_vectors_1, labels_1, filenames, window_idx= C.make_label(max_files=5,quality=[1],is_usable=None,path = path,seed=10,make_pca=False)
feature_vectors_9_10, labels_9_10, filenames1, window_idx1= C.make_label(max_files=5,quality=[9,10],is_usable=None,path = path,seed=10,make_pca=False)
