...
path=r'C:\Users\Mads-_uop20qq\Documents\fagprojekt\FeatureVectors'
N=23
# feature_vectors_is_usable,labels__is_usable,_,_= C.make_label(make_from_names=True,quality=None,is_usable="Yes",max_files=N,path = path) #18 files = 2144
# feature_vectors_not_usable,labels_not_usable,_,_= C.make_label(make_from_names=True,quality=None,is_usable='No',max_files=N ,path = path) #18 files = 1997
#
...
spectrogram_is_usable,labels__is_usable_spec,_,_= C.make_label(make_from_names=True,quality=None,is_usable="Yes",max_files=N,path = path) #18 files = 2074
spectrogram_not_usable,labels_not_usable_spec,_,_= C.make_label(make_from_names=True,quality=None,is_usable='No',max_files=N ,path = path) #18 files = 1926


x_train_spec =np.vstack((spectrogram_is_usable[:2074,:],spectrogram_not_usable[:1926,:]))
y_train_spec = np.hstack((labels__is_usable_spec[:2074],labels_not_usable_spec[:1926]))

x_test_spec = np.vstack((spectrogram_is_usable[2074:,:],spectrogram_not_usable[1926:,:]))
y_test_spec = np.hstack((labels__is_usable_spec[2074:],labels_not_usable_spec[1926:]))
