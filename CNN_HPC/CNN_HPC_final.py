...
np.save('test_labels_final2.npy',np.asarray(Y_valid))
np.save('test_windows_final2.npy',np.asarray(windows_id))
valid_acc_data = np.asarray(val_acc)
np.save((f'valid_acc_l5_0_b2.npy'), valid_acc_data)
all_pred_data = np.asarray(all_pred)
np.save((f'all_guesses_l5_0_b2.npy'), all_pred_data)