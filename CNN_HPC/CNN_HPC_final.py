...
torch.save(modelB.state_dict(), 'model_b_final.pt')
torch.save(X_valid,'test_set_final.pt')
np.save('test_labels_final.npy',np.asarray(Y_valid))
np.save('test_windows_final.npy',np.asarray(windows_id))
